# Boas vindas ao repositório do projeto Dragons!
...
<details>
  ...
  - `git clone git@github.com:FranciscoVieir/Project-dragons-game.git`.
...
Energia é um atributo vital para a maioria dos seres. No contexto de  Dragons`, a energia gasta ao se andar, nadar, escalar ou lutar é chamada de *"stamina"* .
...
Como você pode imaginar, há diversos arquétipos diferentes no mundo de  Dragons*, cada um com as suas peculiaridades e alinhamentos.
